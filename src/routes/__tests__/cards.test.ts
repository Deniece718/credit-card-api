...
const findCardMock = jest.spyOn(Card, 'findById').mockImplementation(
  () =>
    Promise.resolve(
      {
...
const updateCardMock = jest.spyOn(Card, 'findByIdAndUpdate').mockImplementation(
  () =>
    Promise.resolve(
      {
        _id: '6913a78345e9890b855e3f59',
...
const findInvoiceMock = jest.spyOn(Invoice, 'find').mockImplementation(
  () =>
    Promise.resolve(
      [
        {
...
const findTransactionMock = jest.spyOn(Transaction, 'find').mockImplementation(
  () =>
    Promise.resolve(
      [
        {
